...
/**
 * It takes a model object and returns a DTO object with some of the model's properties and some of the
 ...
 */
const collectionStoresModelsToDto = (stores) => {
  return stores.map(store => mapStoresModelToDto(store));
}
